                ...
                <tr className="text-center " key={story.id}>
                  ...
                  <td className="py-2 border-2">
                    <div className="flex justify-around">
                      ...
                      <div className="px-4 py-2 text-white bg-orange-400 cursor-pointer rounded-2xl">
                        <Link to={`/management/edit-story/${story.id}`}>
                          <span>Edit</span>
                        </Link>
                      </div>
                      <div className="px-4 py-2 text-white bg-red-500 cursor-pointer rounded-2xl" onClick={() => handleDeleteStory(story.id)}>
                        <span>Delete</span>
                      </div>
                    </div>
                  </td>
